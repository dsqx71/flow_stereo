...
@register
def dispnet_pretrain(epoch, ctx):
    """
    ...
    # optimizer params
    optimizer_type = 'Adam'
    optimizer_setting = dict(learning_rate=1e-4,
                             beta1=0.90,
                             beta2=0.999,
                             epsilon=1e-4,
                             decay_factor=0.0001,
    ...
    augment_pipeline = augmentation.augmentation(max_num_tries=30,
                                                 ...
                                                 translate_range={'method': 'uniform', 'low': -0.2, 'high': 0.2},
                                                 zoom_range={'method': 'normal', 'mean': 1.0, 'scale': 0.5},
                                                 squeeze_range={'method': 'normal', 'mean': 1.0, 'scale': 0.4},
                                                 gamma_range={'method': 'normal', 'mean': 1.0, 'scale': 0.5},
                                                 brightness_range={'method': 'normal', 'mean': 0.0, 'scale': 0.005},
