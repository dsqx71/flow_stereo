...
# sys.path.append('/home/xudong/flownet2/python/caffe/')
prototxt = '/home/xudong/flownet2/models/FlowNet2-CSS/FlowNet2-CSS_train.prototxt.template'
model = '/home/xudong/flownet2/models/FlowNet2-CSS/FlowNet2-CSS_weights.caffemodel.h5'
...
caffe.set_mode_gpu()
net = caffe.Net(prototxt, model, caffe.TRAIN)
...
loss_scale = {}
loss_scale['flownetc'] = {'loss2': 0.00,
                          'loss3': 0.00,
                          'loss4': 0.00,
                          'loss5': 0.00,
                          'loss6': 0.00}
...
loss_scale['flownets1'] = {'loss2': 0.00,
                           'loss3': 0.00,
                           'loss4': 0.00,
                           'loss5': 0.00,
                           'loss6': 0.00}

loss_scale['flownets2'] = {'loss2': 0.00,
                           'loss3': 0.00,
                           'loss4': 0.00,
                           'loss5': 0.00,
                           'loss6': 0.00}
    
symbol,_  = flownet2CSS(loss_scale, net_type='flow', is_sparse=False)
...
# init._init_weight(None,exe.arg_dict['upsamplingop_flows1_weight'])
# init._init_weight(None,exe.arg_dict['upsamplingop_flows2_weight'])

for key in exe.arg_dict:
    if exe.arg_dict[key].asnumpy().sum() == 0:
        print key

img1 = net.blobs['img0_aug'].data
img2 = net.blobs['img1_aug'].data
...
mx.model.save_checkpoint(prefix='/rawdata/checkpoint_flowstereo/model_zoo/caffe_flownet2CSS', 
                         epoch = 0, 
                         symbol=symbol, 
