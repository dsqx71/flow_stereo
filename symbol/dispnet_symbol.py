...
def stereo_net(is_sparse = False,
    ...
    # corr = mx.sym.LeakyReLU(data = corr, act_type =  'leaky', slope  = 0.1 ,name = 'corr_relu')
    ...
    conv3a = mx.sym.Convolution(concat, pad=(2, 2), kernel=(5, 5), stride=(2, 2), num_filter=256, name='conv3a')
    ...
    pr1 = mx.sym.Convolution(iconv1,pad=(1,1),kernel=(3,3),stride=(1,1),num_filter=1,name='pr1')

    loss, pr = get_loss(pr1, downsample1, loss1_scale, name='loss1',get_data=True, is_sparse = is_sparse)
